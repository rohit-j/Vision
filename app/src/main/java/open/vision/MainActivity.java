...
public class MainActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (viewMode) {
            ...
            case VIEW_MODE_FEATURES:
                // Native JNI call to Opencv Findfeatures API.
                mRgba = inputFrame.rgba();
                mGray = inputFrame.gray();
                FindFeatures(mGray.getNativeObjAddr(), mRgba.getNativeObjAddr());
                break;
            case VIEW_MODE_GRAPH_VISION:
                // Native JNI call to custom Graph Vision API.
                mRgba = inputFrame.rgba();
                GraphVision(mRgba.getNativeObjAddr());
                break;
            case VIEW_MODE_TRANSPARENT_3D_VIEW:
                // Native JNI call to custom Transparent 3D View API.
                mRgba = inputFrame.rgba();
                Transparent3DView(mGray.getNativeObjAddr(), mRgba.getNativeObjAddr());
                break;
        }
    ...
    public native void GraphVision(long matAddrRgba);
    public native void Transparent3DView(long matAddrGr, long matAddrRgba);
}
